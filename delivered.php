...
$query2 = "INSERT INTO delivered_orders(order_id, cust_name, price, address, suppliername)
SELECT order_id, cust_name, Total, address, '$_SESSION[delivery_name]' FROM order_details WHERE order_id = '$id';";
$query3 = "INSERT INTO delivered_orders(suppliername) VALUES ('$_SESSION[delivery_name]');";
$result3 = $conn->query($query2);

$query = "DELETE FROM order_details WHERE order_id = '$id';";
$result1 = mysqli_query($conn, $query);

$sql2 = " SELECT order_id, cust_name, itemname, price, quantity, Total, address FROM order_details";
    ...
    <div class="container1"><br>
        <ul class="responsive-table">
            <li class="table-header">
                ...
                <div class="col col-3"><b>Address</b></div>
