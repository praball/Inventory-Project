...
$sql1 = "INSERT INTO cart(product_name, cust_name, price, quantity, address) VALUES('$iname','$_SESSION[user_name]','$price3','$qtt','$addrr');";
...
//    $insert1 = "INSERT INTO order_details(cust_name, itemname, price, quantity, Total, address) VALUES('$_SESSION[cust_name]',    );";
  ...
  $insert1 = "INSERT INTO order_details (cust_name, itemname, price, quantity, address)
    ...
    FROM cart
    WHERE cust_name = '$_SESSION[cust_name]'; ";

    $sql3 = "DELETE FROM cart WHERE cust_name = '$_SESSION[cust_name]';";
...
<body>
    ...
    <h1 style="background-color: black; color:aliceblue; padding:3px;"><u>Invoice:</u></h1><br>
    <hr><br>
    ...
    <div>
        <form action="cart2.php" method="post" onsubmit="myFunction()">
            ...
            <br><br>
            <hr><br>
            <a style="margin-left: 1160px; border: 2px black; background-color: black; color:aliceblue; padding:5px;">
                <b>Total Bill : &dollar;
                    <span id="val"></span>
                </b></a><br>
