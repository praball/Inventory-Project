...
$devname = mysqli_real_escape_string($conn, $_SESSION['delivery_name']);


$sql2 = " SELECT order_id, cust_name, price, address FROM delivered_orders WHERE suppliername = '$devname';";
        ...
        <table>
            ...
            ?>
                <tr>
                    ...
                    ROW OF EVERY COLUMN -->
                        <td><input type="text" readonly name="name" value="<?php echo $rows['order_id']; ?>"> </td>

                        <td><input type="text" name="price" value=" <?php echo $rows['cust_name']; ?>" readonly></td>

                        <td><input type="text" name="quantity" value="<?php echo $rows['price']; ?>" readonly></td>

                        <td><input type="text" name="total" value=" <?php echo $rows['address']; ?>" readonly></td>
