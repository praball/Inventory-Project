...
<body>
   ...
   <nav class="navbar navbar-expand-lg navbar-light bg-light" style="z-index: 1000;">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
         ...
         <a href = "cart1.php" button type="button" class="btn btn-outline-primary" style="margin-right:8px;">Your cart</a>
   ...
   <div class="container">
      ...
      <div class="content">
         <h3 style="color: black; font-weight:bold;">Hi <span style="background-color: black;">customer!</span></h3>
         <h1 class='userpage' style='
         background-color: rgb(255, 204 , 213); color:black'>Welcome <span><b><?php echo $_SESSION['user_name'] ?></b></span></h1>
      </div>
   </div><br><hr><br>
